...
public enum Locations {
	...
	ALKHARID_SMELT(new RSTile(3275, 3187), new RSTile(3278, 3185), 0), 
	...
	FALADOR_SMELT(new RSTile(2971, 3373), new RSTile(2975, 3368), 0), 
	...
	MOTHERLOAD_MINE(new RSTile(3714, 5690,0), new RSTile(3773, 5635,0)),
