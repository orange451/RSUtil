...
public enum Locations {
	...
	TUTORIAL_ISLAND_START_NEW( new RSTile(1683, 6118, 0), new RSTile(1687, 6110, 0) ),
	TUTORIAL_ISLAND_SURVIVAL_NEW( new RSTile(1692, 6107, 0), new RSTile(1697, 6103, 0) ),
	...
	TEMPLE_DUNGEON_DREZELS_ROOM(new RSTile(3437, 9899, 0), new RSTile(3442, 9895, 0)),
